...
<section class="mt-8 text-xl">
			...
			<table>
				...
				<tbody>
					<tr>
						<th>이름</th>
						<td>
							<input class="w-full input input-bordered input-info w-full max-w-xs" name="name" type="text" placeholder="이름을 입력해주세요" />
						</td>
					</tr>
					<tr>
						<th>이메일</th>
	...
	<div class="container mx-auto btns mt-1 px-3">
